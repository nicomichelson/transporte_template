function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegcionResponsive)}function navegcionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
